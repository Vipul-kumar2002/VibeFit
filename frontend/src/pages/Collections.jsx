...
import advertisementImg from "../assets/advertisement (1).jpg";
  ...
  return (
    <div className="w-[99vw]  min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start flex-col md:flex-row justify-start  pt-[70px] overflow-x-hidden z-[2] pb-[110px]">
      ...
      <div className="lg:pl-[20%] md:py-[10px] ">
        {/* Advertisement image at top */}
        <div className="w-full flex justify-center mb-8">
          <img
            src={advertisementImg}
            alt="Ultimate Style Destination - Your Next-Level Look Is Here"
            className="w-full max-w-[1200px] h-auto object-contain rounded-lg shadow"
          />
        </div>
        ...
        <div className="md:w-[80vw] w-[100vw] flex justify-between flex-col lg:flex-row lg:px-[50px]">
          ...
          <select
            name=""
            id=""
            className="bg-slate-600 w-[60%] md:w-[200px] h-[50px] px-[10px] text-white rounded-lg hover:border-[#46d1f7] border-2"
        ...
        {/* Product cards */}
        <div className="lg:w-[80vw] md:w-[60vw] w-[100vw] min-h-[70vh] flex items-center justify-center flex-wrap gap-8">
